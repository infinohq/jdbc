...
import org.infino.jdbc.config.KeyStoreLocationConnectionProperty;
import org.infino.jdbc.config.KeyStorePasswordConnectionProperty;
import org.infino.jdbc.config.TrustStoreLocationConnectionProperty;
import org.infino.jdbc.config.TrustStorePasswordConnectionProperty;
import org.infino.jdbc.logging.InfinoConnection;
import org.infino.jdbc.test.TLSServer;
...
public class SSLClientAuthTests {
    ...
    static void beforeAll(@TempDirectory.TempDir Path tempDir) throws Exception {
        ...
        jettyServer = TLSServer.startSecureServer(host,
                ...
                "JKS",
                true,
                new TLSServer.MockInfinoConnectionHandler());
