...
import org.infino.jdbc.protocol.exceptions.MalformedResponseException;
...
import org.infino.jdbc.protocol.http.JsonQueryRequest;
import org.infino.jdbc.protocol.http.JsonQueryResponse;
import org.infino.jdbc.test.mocks.MockCloseableHttpResponseBuilder;
import org.infino.jdbc.test.mocks.MockInfino;
import org.infino.jdbc.test.mocks.MockHttpTransport;
...
public class JsonHttpProtocolTests {
        ...
        void testConnect() throws IOException {
                CloseableHttpResponse mockResponse = new MockCloseableHttpResponseBuilder()
                                ...
                                .withResponseBody(MockInfino.INSTANCE.getConnectionResponse())
                                .build();
                ...
                Assertions.assertEquals(
                                buildJsonQueryResponse(
                                                ...
                                                toDatarows(
                                                                ...
                                                                toDatarow("2015-01-01 00:34:53", "1", 1, 24.5, 0.5,
                                                                                "2")),
                                                5, 1000, 200),
                                response);
        }
        ...
        void testQueryResponseSqlPluginPossiblyMissing() throws IOException {
                ...
                assertTrue(responseException.getCause() instanceof HttpException,
                                () -> "ResponseException cause expected to " +
                                                "be of type " + HttpException.class + " but was: "
