...
import org.infino.jdbc.DatabaseMetaDataImpl.ColumnMetadataStatement;
...
public class DatabaseMetaDataTests {
    ...
    void testClusterMetaData() throws ResponseException, IOException, SQLException {
        ...
        assertEquals("Infino", dbmd.getDatabaseProductName());
    ...
    void testGetAttributes() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("TYPE_NAME")
                .column("ATTR_NAME")
                .column("DATA_TYPE", InfinoType.INTEGER)
                .column("ATTR_TYPE_NAME")
                .column("ATTR_SIZE", InfinoType.INTEGER)
                .column("DECIMAL_DIGITS", InfinoType.INTEGER)
                .column("NUM_PREC_RADIX", InfinoType.INTEGER)
                .column("NULLABLE", InfinoType.INTEGER)
                .column("REMARKS")
                .column("ATTR_DEF")
                .column("SQL_DATA_TYPE", InfinoType.INTEGER)
                .column("SQL_DATETIME_SUB", InfinoType.INTEGER)
                .column("CHAR_OCTET_LENGTH", InfinoType.INTEGER)
                .column("ORDINAL_POSITION", InfinoType.INTEGER)
                .column("IS_NULLABLE")
                .column("SCOPE_CATALOG")
                .column("SCOPE_SCHEMA")
                .column("SCOPE_TABLE")
                .column("SOURCE_DATA_TYPE", InfinoType.SHORT)
                .build();
    ...
    void testGetUDTs() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("DATA_TYPE", InfinoType.INTEGER)
                .column("REMARKS")
                .column("BASE_TYPE", InfinoType.SHORT)
                .build();
    ...
    void testGetProcedures() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("RESERVED6")
                .column("REMARKS")
                .column("PROCEDURE_TYPE", InfinoType.SHORT)
    ...
    void testGetProcedureColumns() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("PROCEDURE_NAME")
                .column("COLUMN_NAME")
                .column("COLUMN_TYPE", InfinoType.SHORT)
                .column("DATA_TYPE", InfinoType.INTEGER)
                .column("TYPE_NAME")
                .column("PRECISION", InfinoType.INTEGER)
                .column("LENGTH", InfinoType.INTEGER)
                .column("SCALE", InfinoType.SHORT)
                .column("RADIX", InfinoType.SHORT)
                .column("NULLABLE", InfinoType.SHORT)
                .column("REMARKS")
                .column("COLUMN_DEF")
                .column("SQL_DATA_TYPE", InfinoType.INTEGER)
                .column("SQL_DATETIME_SUB", InfinoType.INTEGER)
    ...
    void testGetFunctions() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("REMARKS")
                .column("FUNCTION_TYPE", InfinoType.SHORT)
                .column("SPECIFIC_NAME")
                .build();
    ...
    void testPseudoColumns() throws ResponseException, IOException, SQLException {
        ...
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                ...
                .column("COLUMN_NAME")
                .column("DATA_TYPE", InfinoType.INTEGER)
                .column("COLUMN_SIZE", InfinoType.INTEGER)
                .column("DECIMAL_DIGITS", InfinoType.INTEGER)
                .column("NUM_PREC_RADIX", InfinoType.INTEGER)
                .column("COLUMN_USAGE")
                .column("REMARKS")
    ...
    void testGetColumnsWithoutColumnNamePattern() throws Exception {
        ...
        ColumnMetadataStatement stmt = new ColumnMetadataStatement((ConnectionImpl) con, "TABLE_%", null,
                NoOpLogger.INSTANCE);
    ...
    void testGetColumnsWithColumnNamePattern() throws Exception {
        ...
        ColumnMetadataStatement stmt = new ColumnMetadataStatement((ConnectionImpl) con, "TABLE_%", "COLUMN_%",
                NoOpLogger.INSTANCE);
    ...
    private MockResultSet getExpectedCatalogsResultSet() {
        MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                .column("TABLE_CAT", InfinoType.TEXT)
                .build();
    ...
    private MockResultSetMetaData getMockSchemaResultSetMetaData() {
        return MockResultSetMetaData.builder()
                .column("TABLE_SCHEM", InfinoType.TEXT)
                .column("TABLE_CATALOG", InfinoType.TEXT)
                .build();
    }
    ...
    private Connection getMockConnection() throws ResponseException, IOException, SQLException {
        ...
        InfinoVersion mockEV = mock(InfinoVersion.class);
