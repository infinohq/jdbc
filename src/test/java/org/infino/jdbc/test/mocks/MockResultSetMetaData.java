...
public class MockResultSetMetaData implements ResultSetMetaData, JdbcWrapper {
    ...
    public static class Builder {
        ...
        public Builder column(String columnName) {
            column(columnName, InfinoType.TEXT);
            return this;
        }

        public Builder column(String columnName, InfinoType columnType) {
            column();
            setColumnName(columnName);
            setColumnInfinoType(columnType);
            return this;
        }
        ...
        public Builder setColumnInfinoType(final InfinoType InfinoType) {
            setColumnType(InfinoType.getJdbcType().getVendorTypeNumber());
            setPrecision(InfinoType.getPrecision());
            setColumnDisplaySize(InfinoType.getDisplaySize());
            setColumnClassName(InfinoType.getJavaClassName());
            setColumnTypeName(InfinoType.getJdbcType().getName());
            setSigned(InfinoType.isSigned());
            return this;
        }
    ...
    public void assertMatches(ResultSetMetaData other) throws SQLException {
        ...
        for (int i = 1; i <= this.getColumnCount(); i++) {
            ...
            assertEquals(this.getColumnDisplaySize(i), other.getColumnDisplaySize(i),
                    "column " + i + " column disp size");
            ...
            assertEquals(this.isDefinitelyWritable(i), other.isDefinitelyWritable(i),
                    "column " + i + " definitely writable");
        }
    }
