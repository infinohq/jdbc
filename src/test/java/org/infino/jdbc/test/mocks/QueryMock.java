...
public abstract class QueryMock {
    ...
    public void assertConnectionResponse(InfinoConnection esConnection) throws SQLException {
        MockInfino.INSTANCE.assertMockInfinoConnectionResponse(esConnection);
    }
    ...
    public static class NycTaxisQueryMock extends QueryMock {
        ...
        public MockResultSet getMockResultSet() {
            MockResultSetMetaData mockResultSetMetaData = MockResultSetMetaData.builder()
                    .column("pickup_datetime", InfinoType.TIMESTAMP)
                    .column("trip_type", InfinoType.KEYWORD)
                    .column("passenger_count", InfinoType.INTEGER)
                    .column("fare_amount", InfinoType.SCALED_FLOAT)
                    .column("extra", InfinoType.SCALED_FLOAT)
                    .column("vendor_id", InfinoType.KEYWORD)
                    .build();
