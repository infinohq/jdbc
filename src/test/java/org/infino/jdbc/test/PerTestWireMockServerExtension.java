 ...
 * <p>
 * <li>
 * Before each test, mock server is started and made available to the Test as a
 * parameter.
 * Note: if a test does not declare a {@link WireMockServer} parameter, no mock
 * server
 * instance is created.
 * </li>
 * <li>
