...
import org.infino.jdbc.internal.util.AwsHostNameUtil;
...
public class ConnectionConfig {
    ...
    private ConnectionConfig(Builder builder) {
        ...
        this.accountId = builder.getAccountIdConnectionProperty().getValue();
    }
    ...
    public static class Builder {
        ...
        private TunnelHostConnectionProperty tunnelHostConnectionProperty = new TunnelHostConnectionProperty();

        private AccountIdConnectionProperty accountIdConnectionProperty = new AccountIdConnectionProperty();
        ...
        public AccountIdConnectionProperty getAccountIdConnectionProperty() {
            return accountIdConnectionProperty;
        }
        ...
        // public DriverPropertyInfo[] buildDriverPropertyInfo() throws
        ...
        private void validateConfig() throws ConnectionPropertyException {
            ...
            if (authenticationType == AuthenticationType.NONE) {
                ...
                throw new ConnectionPropertyException(authConnectionProperty.getKey(),
                    ...
                    || authenticationType == AuthenticationType.AWS_SIGV4_SERVERLESS) &&
