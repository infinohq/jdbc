...
import org.infino.jdbc.protocol.JdbcDateTimeFormatter;
import org.infino.jdbc.protocol.JdbcQueryParam;
...
public class PreparedStatementImpl extends StatementImpl implements PreparedStatement {
    ...
    public void setNull(int parameterIndex, int sqlType) throws SQLException {
        ...
        checkOpen();
        setParameter(parameterIndex, InfinoType.fromJdbcType(JDBCType.valueOf(sqlType)).getTypeName(), null);
    ...
    public void setString(int parameterIndex, String x) throws SQLException {
        ...
        checkOpen();
        setParameter(parameterIndex, InfinoType.fromJdbcType(JDBCType.VARCHAR).getTypeName(), x);
