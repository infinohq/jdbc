...
public class DatabaseMetaDataImpl implements DatabaseMetaData, JdbcWrapper, LoggingSource {
    ...
    public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern)
        ...
        return emptyResultSet(log,
                ...
                rscd("RESERVED6"),
                rscd("REMARKS"),
                rscd("PROCEDURE_TYPE", InfinoType.SHORT.getTypeName()),
                rscd("SPECIFIC_NAME"));
    }
    ...
    public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedureNamePattern,
        ...
        return emptyResultSet(log,
                ...
                rscd("PROCEDURE_NAME"),
                rscd("COLUMN_NAME"),
                rscd("COLUMN_TYPE", InfinoType.SHORT.getTypeName()),
                rscd("DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("TYPE_NAME"),
                rscd("PRECISION", InfinoType.INTEGER.getTypeName()),
                rscd("LENGTH", InfinoType.INTEGER.getTypeName()),
                rscd("SCALE", InfinoType.SHORT.getTypeName()),
                rscd("RADIX", InfinoType.SHORT.getTypeName()),
                rscd("NULLABLE", InfinoType.SHORT.getTypeName()),
                rscd("REMARKS"),
                rscd("COLUMN_DEF"),
                rscd("SQL_DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("SQL_DATETIME_SUB", InfinoType.INTEGER.getTypeName()),
                rscd("CHAR_OCTET_LENGTH", InfinoType.INTEGER.getTypeName()),
                rscd("ORDINAL_POSITION", InfinoType.INTEGER.getTypeName()),
                rscd("IS_NULLABLE"),
                rscd("SPECIFIC_NAME"));
    }
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types)
            throws SQLException {
        // TODO - when server plugin supports PreparedStatement fully, implement this as
        // a preparedStatement with params
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern)
        ...
        ColumnMetadataStatement statement = new ColumnMetadataStatement(connection, tableNamePattern, columnNamePattern,
                log);
    ...
    public ResultSet getTypeInfo() throws SQLException {
        ...
        columnDescriptors.add(rscd("DATA_TYPE", InfinoType.INTEGER.getTypeName()));
        columnDescriptors.add(rscd("PRECISION", InfinoType.INTEGER.getTypeName()));
        ...
        columnDescriptors.add(rscd("NULLABLE", InfinoType.SHORT.getTypeName()));
        columnDescriptors.add(rscd("CASE_SENSITIVE", InfinoType.BOOLEAN.getTypeName()));
        columnDescriptors.add(rscd("SEARCHABLE", InfinoType.SHORT.getTypeName()));
        columnDescriptors.add(rscd("UNSIGNED_ATTRIBUTE", InfinoType.BOOLEAN.getTypeName()));
        columnDescriptors.add(rscd("FIXED_PREC_SCALE", InfinoType.BOOLEAN.getTypeName()));
        columnDescriptors.add(rscd("AUTO_INCREMENT", InfinoType.BOOLEAN.getTypeName()));
        columnDescriptors.add(rscd("LOCAL_TYPE_NAME"));
        columnDescriptors.add(rscd("MINIMUM_SCALE", InfinoType.SHORT.getTypeName()));
        columnDescriptors.add(rscd("MAXIMUM_SCALE", InfinoType.SHORT.getTypeName()));
        columnDescriptors.add(rscd("SQL_DATA_TYPE", InfinoType.INTEGER.getTypeName()));
        columnDescriptors.add(rscd("SQL_DATETIME_SUB", InfinoType.INTEGER.getTypeName()));
        columnDescriptors.add(rscd("NUM_PREC_RADIX", InfinoType.INTEGER.getTypeName()));

        List<List<Object>> dataRows = new ArrayList<>();
        for (InfinoType InfinoType : InfinoType.values()) {
            dataRows.add(Arrays.asList(
                    InfinoType.name(),
                    InfinoType.getJdbcType().getVendorTypeNumber(),
                    InfinoType.getPrecision(),
                    "'",
                    "'",
                    null,
                    typeNullableUnknown,
                    (InfinoType == InfinoType.TEXT || InfinoType == InfinoType.KEYWORD), // case sensitive
                    typeSearchable,
                    !InfinoType.isSigned(),
                    false,
                    false,
    ...
    public ResultSet getUDTs(String catalog, String schemaPattern, String typeNamePattern, int[] types)
        ...
        return emptyResultSet(log,
                ...
                rscd("DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("REMARKS"),
                rscd("BASE_TYPE", InfinoType.SHORT.getTypeName()));
    }
    ...
    public ResultSet getAttributes(String catalog, String schemaPattern, String typeNamePattern,
        ...
        return emptyResultSet(log,
                ...
                rscd("DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("ATTR_TYPE_NAME"),
                rscd("ATTR_SIZE", InfinoType.INTEGER.getTypeName()),
                rscd("DECIMAL_DIGITS", InfinoType.INTEGER.getTypeName()),
                rscd("NUM_PREC_RADIX", InfinoType.INTEGER.getTypeName()),
                rscd("NULLABLE", InfinoType.INTEGER.getTypeName()),
                rscd("REMARKS"),
                rscd("ATTR_DEF"),
                rscd("SQL_DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("SQL_DATETIME_SUB", InfinoType.INTEGER.getTypeName()),
                ...
                rscd("SCOPE_SCHEMA"),
                rscd("SCOPE_TABLE"),
                rscd("SOURCE_DATA_TYPE", InfinoType.SHORT.getTypeName()));
    }
    ...
    public ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern)
        ...
        return emptyResultSet(log,
                ...
                rscd("FUNCTION_NAME"),
                rscd("REMARKS"),
                rscd("FUNCTION_TYPE", InfinoType.SHORT.getTypeName()),
                rscd("SPECIFIC_NAME"));
    }
    ...
    public ResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
        ...
        return emptyResultSet(log,
                ...
                rscd("COLUMN_NAME"),
                rscd("DATA_TYPE", InfinoType.INTEGER.getTypeName()),
                rscd("COLUMN_SIZE", InfinoType.INTEGER.getTypeName()),
                rscd("DECIMAL_DIGITS", InfinoType.INTEGER.getTypeName()),
                rscd("NUM_PREC_RADIX", InfinoType.INTEGER.getTypeName()),
                rscd("COLUMN_USAGE"),
                rscd("REMARKS"),
    ...
    static ResultSetColumnDescriptor rscd(String name) {
        return rscd(name, InfinoType.TEXT.getTypeName(), null);
    }
    ...
    static class ColumnMetadataStatement extends PreparedStatementImpl {
        ...
        ColumnMetadataStatement(ConnectionImpl connection, String tableNamePattern, String columnNamePattern,
                Logger log)
                throws SQLException {
            // TODO - once sql plugin supports PreparedStatement fully, do this through a
            // preparedStatement with params
        ...
        static class ColumnMetadataResultSet extends ResultSetImpl {
            ...
            private int getDataType() {
                ...
                return InfinoType.fromTypeName(esDataType, false).sqlTypeNumber();
            }

            private String getDataTypeName() {
                String esDataType = (String) cursor.getColumn(5);
                return InfinoType.fromTypeName(esDataType, false).name();
            }

            private int getColumnSize() {
                String esDataType = (String) cursor.getColumn(5);
                return InfinoType.fromTypeName(esDataType, false).getPrecision();
            }
            ...
            for (ColumnDescriptor cd : queryResponse.getColumnDescriptors()) {
                if ("DATA_TYPE".equals(cd.getName()) || "COLUMN_SIZE".equals(cd.getName())) {
                    columnDescriptors.add(
                            rscd(cd.getName(), InfinoType.INTEGER.getTypeName()));
                } else {
