...
public class StructImpl implements Struct {
    ...
    /**
     * Constructs a new {@code StructImpl} object with the specified parameter
     * values.
     *
     * @param typeName   the SQL type name of the struct
     * @param attributes the attributes of the struct, each attribute is a
     *                   {@code Map.Entry<K, V>}(key-value pair)
     */
    ...
    /**
     * @throws java.lang.UnsupportedOperationException because functionality is not
     *                                                 supported yet
     */
    @Override
     ...
     *
     * <p>
     * Two StructImpl objects are considered equal if they have the same typeName,
     * same number of attributes,
     * and contain the same attributes.
     * </p>
     *
     * @param obj the object to compare with this StructImpl object for equality.
     * @return {@code true} if the specified object is equal to this StructImpl
