...
public class JsonHttpResponseHandler {
    ...
    public static final Set<Integer> DEFAULT_ACCEPTABLE_HTTP_CODES = Collections
            .unmodifiableSet(new HashSet<>(Arrays.asList(HttpStatus.SC_OK)));

    public JsonHttpResponseHandler(JsonHttpProtocol protocol) {
        this.protocol = protocol;
    }

    public <R> R handleResponse(HttpResponse response, JsonContentParser<InputStream, R> contentParser)
