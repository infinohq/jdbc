...
/**
 * Infino {@link DataSource} implementation.
 * <p>
 ...
 */
public class InfinoDataSource implements DataSource, JdbcWrapper, LoggingSource {
    ...
    private Connection getConnection(Map<String, Object> overrideProperties)
        ...
        org.infino.jdbc.logging.Logger log = Driver.initLog(connectionConfig);
